		...
		window.onload = function(){			
			...
			cargaProvinciasXML("http://localhost:8080/Ejercicios8/ColEjerciciosT8/Ejercicio1/cargaProvinciasXML.php");//cargamos los datos del xml nada mas cargar la pagina
		...
		function cargaMunicipiosXML(){
		   ...
		   //3-Realizar la petición al servidor
		   peticion_http.open("POST", "http://localhost:8080/Ejercicios8/ColEjerciciosT8/Ejercicio1/cargaMunicipiosXML.php?nocache=" + Math.random(), true);
		   //4-Ejecutar la función de respuesta.
