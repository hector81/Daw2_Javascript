		...
		window.onload = function(){			
			...
			cargaProvinciasJSON("http://localhost/Ejercicios8/ColEjerciciosT8/Ejercicio2/cargaProvinciasJSON.php");//cargamos los datos del xml nada mas cargar la pagina
		...
		function cargaMunicipiosJSON(){
		   ...
		   //3-Realizar la petición al servidor
		   peticion_http.open("POST", "http://localhost/Ejercicios8/ColEjerciciosT8/Ejercicio2/cargaMunicipiosJSON.php?nocache=" + Math.random(), true);
		   //4-Ejecutar la función de respuesta.
